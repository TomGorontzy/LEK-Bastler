...
Aktueller Versionsstand: **3.5.2** (aus `src/build_version_info.txt`).
...
- `dist/LEK-Bastler-Portable_3.5.2/LEK-Bastler-Portable_3.5.2.exe`
- `release/LEK-Bastler-Portable_3.5.2.zip`
