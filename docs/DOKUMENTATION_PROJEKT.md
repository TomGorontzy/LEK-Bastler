...
Aktueller Versionsstand: **3.5.3** (aus `src/build_version_info.txt`).
...
- `dist/LEK-Bastler-Portable_3.5.3/LEK-Bastler-Portable_3.5.3.exe`
- `release/LEK-Bastler-Portable_3.5.3.zip`
